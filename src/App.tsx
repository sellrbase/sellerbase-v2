...
function Sellerbase({ session }: { session: Session }) {
  ...
  const loadBusinessData = async (businessId: string) => {
    setLoading(true);
    const [itemsRes, salesRes, expensesRes, actionsRes, notificationsRes, platformsRes] =
      await Promise.all([
        supabase
  ...
  const notices = useMemo(
    () => buildNotices(items, expenses, sales, notifications),
    [items, expenses, sales, notifications],
  );
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="nav-list">
          <NavButton icon={<Home />} label="Home" page="home" active={page} onClick={setPage} />
          <NavButton
            icon={<Bell />}
            label="Notifications"
            page="notifications"
      ...
      <main className="main">
        ...
        {selectedItem ? (
          ...
          <>
            ...
            {page === "expenses" && (
              <ExpensesPage business={business} expenses={expenses} onRefresh={refresh} />
            )}
            {page === "targets" && <Placeholder title="Targets" />}
            {page === "analytics" && <Placeholder title="Analytics" />}
            {page === "tax" && <Placeholder title="Tax Summary" />}
            {page === "settings" && (
  ...
  return (
    <div className="page-stack">
      <div className="stat-grid">
        ...
        <Stat label="Net profit this month" value={gbp(profit)} icon={<Calculator />} />
    ...
    <div className="page-stack">
      ...
      <section className="listing-hero">
        ...
        <div className="hero-actions">
          <button className="ghost-button">Edit listing</button>
